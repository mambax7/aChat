    ...
    public static function checkVerModule($helper, $source = 'github', $default = 'master')
    {
        ...
        if ('github' === $source) {
            if (function_exists('curl_init') && false !== ($curlHandle = curl_init())) {
                ...
                curl_setopt($curlHandle, CURLOPT_SSL_VERIFYPEER, true); //TODO: how to avoid 'Peer's Certificate issuer is not recognized'
                curl_setopt(
                    $curlHandle,
                    CURLOPT_HTTPHEADER,
                    [
                ...
                if (false === $curlReturn) {
                    ...
                    $moduleVersion = ($helper->getConfig('version') . '_' . $helper->getConfig('module_status'));
                    //"PHP-standardized" version
