...
<div class="panel panel-info">
    <div class="panel-heading"><h2 class="panel-title">Messages </h2></div>
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><{$smarty.const.MD_ACHAT_MESSAGES_MID}></td>
            <td><{$messages.mid}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_UID}></td>
            <td><{$messages.uid}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_UNAME}></td>
            <td><{$messages.uname}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_MSG}></td>
            <td><{$messages.msg}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_COLOR}></td>
            <td><span style="background-color: <{$messages.color}>;">&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_DATE}></td>
            <td><{$messages.date}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_MESSAGES_IP}></td>
            <td><{$messages.ip}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_ACHAT_ACTION}></td>
            <td>
